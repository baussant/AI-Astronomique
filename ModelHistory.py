...
def save_knn_results(sampling_number,sampling_strategy,Smote,PCA_Number,best_params,knn_model, scaler, pca, PCA_State, params, report, images,Value_cv, variance, Y_Target, X_Chara, neighbor_max,neighbor_min, Echantillon_min,accuracy,train_accuracy, output_folder="KNN"):
    """
    ...
    with open(parameter_filename, "w") as f:
        ...
        f.write(f"Neighbor_min: {neighbor_min}\n")
